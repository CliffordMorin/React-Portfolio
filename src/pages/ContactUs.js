...
import { faEnvelopeSquare, faMapMarkedAlt, faUserAstronaut, faPhone } from '@fortawesome/free-solid-svg-icons';
				...
				<div className="col border-right border-dark border-4">
					<Hide>
						<SocialStyle variants={titleAnim}>
							<FontAwesomeIcon icon={faUserAstronaut} size="3x" color="#2314d0" />
					...
					<Hide>
						<SocialStyle variants={titleAnim}>
							...
							<a href="mailto:cemorin21@gmail.com" target="_blank" rel="noreferrer">
				...
				<div className="col border-left border-dark border-4 ">
					...
					<Hide>
						<SocialStyle variants={titleAnim}>
							...
							<a
								href="https://drive.google.com/file/d/1JdvKxgSzVMBKqaWXuag6NLgOA-bcoAkJ/view?usp=sharing"
								target="_blank"
								rel="noreferrer"
							>
								<h2>My Resume</h2>
